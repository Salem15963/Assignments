...
<br>
<br>
<h1 style=color:blue; class="ms-5">Language Details</h1>
<br>	
...
<p class="ms-3"><a href="/languages/${language.id}/edit">Edit</a></p>
<p class="ms-3"><a href="/languages/${language.id}/delete">Delete</a></p>
</body>
</html>